...
//affichage en HTML
if (prenom_client == undefined || nom_client == undefined || nom_client == undefined || numero_commande_client == undefined || parseInt(totaux_commande).toLocaleString('fr-FR') == NaN) {
...
//console.log(parseInt(totaux_commande).toLocaleString('fr-FR'));
